...
(function(a){var b=0,c=0,d=0,e=0,g="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,f=!1,p=!1,w=!1,D=!1,u=!1,y="pointer",z="pointer",V=[],Q=[],la=[],X=[],J=[],aa=[],K=[],n=[],B=[],ba=[],ga=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,e,k,g,f,l,p){if(a.scrollbar&&a.scrollbarHide)for(var h=c;h<c+25;h++)b[b.length]=m.hideScrollbarIntervalTimer(10*
h,d[c],(c+24-h)/24,e,k,g,f,l,p,a)},hideScrollbarInterval:function(b,c,h,d,g,k,f,l,p){e=-1*b/B[l]*(g-k-f-d);m.setSliderOffset("."+h,e);a("."+h).css({opacity:p.scrollbarOpacity*c,filter:"alpha(opacity:"+p.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,h,d,g,k,f,l,p,w,r,L,z,O,C,x,u,q,E){if(E.infiniteSlider){if(h<=-1*B[x]){var v=a(b).width();if(h<=-1*ba[x]){var A=-1*r[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],A+u);b<L.length&&(L[b]=-1*A);A+=C[b]});h+=-1*L[0];n[x]=-1*
L[0]+u;B[x]=n[x]+v-k;K[x]=0}else{var G=0,S=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")<S&&(S=m.getSliderOffset(this,"x"),G=a)});z=n[x]+v;m.setSliderOffset(a(c)[G],z);n[x]=-1*L[1]+u;B[x]=n[x]+v-k;L.splice(0,1);L.splice(L.length,0,-1*z+u);K[x]++}}if(h>=-1*n[x]||0<=h){v=a(b).width();if(0<h)for(A=-1*r[0],a(c).each(function(b){m.setSliderOffset(a(c)[b],A+u);b<L.length&&(L[b]=-1*A);A+=C[b]}),h-=-1*L[0],n[x]=-1*L[0]+u,B[x]=n[x]+v-k,K[x]=O;0<-1*L[0]-v+u;){var P=0,N=m.getSliderOffset(a(c[0]),
"x");a(c).each(function(a){m.getSliderOffset(this,"x")>N&&(N=m.getSliderOffset(this,"x"),P=a)});z=n[x]-C[P];m.setSliderOffset(a(c)[P],z);L.splice(0,0,-1*z+u);L.splice(L.length-1,1);n[x]=-1*L[0]+u;B[x]=n[x]+v-k;K[x]--;J[x]++}0>h&&(P=0,N=m.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){m.getSliderOffset(this,"x")>N&&(N=m.getSliderOffset(this,"x"),P=a)}),z=n[x]-C[P],m.setSliderOffset(a(c)[P],z),L.splice(0,0,-1*z+u),L.splice(L.length-1,1),n[x]=-1*L[0]+u,B[x]=n[x]+v-k,K[x]--)}}r=!1;k=m.calcActiveOffset(E,
h,L,k,K[x],O,w,x);z=(k+K[x]+O)%O;E.infiniteSlider?z!=aa[x]&&(r=!0):k!=J[x]&&(r=!0);if(r&&(O=new m.args("change",E,b,a(b).children(":eq("+z+")"),z,q),a(b).parent().data("args",O),""!=E.onSlideChange))E.onSlideChange(O);J[x]=k;aa[x]=z;h=Math.floor(h);m.setSliderOffset(b,h);E.scrollbar&&(e=Math.floor((-1*h-n[x]+u)/(B[x]-n[x]+u)*(f-l-g)),b=g-p,h>=-1*n[x]+u?(b=g-p- -1*e,m.setSliderOffset(a("."+d),0)):(h<=-1*B[x]+1&&(b=f-l-p-e),m.setSliderOffset(a("."+d),e)),a("."+d).css({width:b+"px"}))},slowScrollHorizontal:function(b,
c,h,d,e,k,g,f,l,p,w,z,u,O,C,x,D,q,E,F,y){var v=m.getSliderOffset(b,"x");k=[];var G=0,A=25/1024*f;frictionCoefficient=y.frictionCoefficient;elasticFrictionCoefficient=y.elasticFrictionCoefficient;snapFrictionCoefficient=y.snapFrictionCoefficient;e>y.snapVelocityThreshold&&y.snapToChildren&&!E?G=1:e<-1*y.snapVelocityThreshold&&y.snapToChildren&&!E&&(G=-1);e<-1*A?e=-1*A:e>A&&(e=A);a(b)[0]!==a(q)[0]&&(G*=-1,e*=-2);q=K[C];if(y.infiniteSlider)var S=n[C],P=B[C];E=[];for(var A=[],r=0;r<u.length;r++)E[r]=
u[r],r<c.length&&(A[r]=m.getSliderOffset(a(c[r]),"x"));for(;1<e||-1>e;){e*=frictionCoefficient;v+=e;(v>-1*n[C]||v<-1*B[C])&&!y.infiniteSlider&&(e*=elasticFrictionCoefficient,v+=e);if(y.infiniteSlider){if(v<=-1*P){for(var P=a(b).width(),N=0,L=A[0],r=0;r<A.length;r++)A[r]<L&&(L=A[r],N=r);r=S+P;A[N]=r;S=-1*E[1]+F;P=S+P-f;E.splice(0,1);E.splice(E.length,0,-1*r+F);q++}if(v>=-1*S){P=a(b).width();N=0;L=A[0];for(r=0;r<A.length;r++)A[r]>L&&(L=A[r],N=r);r=S-O[N];A[N]=r;E.splice(0,0,-1*r+F);E.splice(E.length-
1,1);S=-1*E[0]+F;P=S+P-f;q--}}k[k.length]=v}A=!1;e=m.calcActiveOffset(y,v,E,f,q,D,J[C],C);y.snapToChildren&&(y.infiniteSlider?(e+q+D)%D!=aa[C]&&(A=!0):e!=J[C]&&(A=!0),0>G&&!A?(e++,e>=u.length&&!y.infiniteSlider&&(e=u.length-1)):0<G&&!A&&(e--,0>e&&!y.infiniteSlider&&(e=0)));if(y.snapToChildren||(v>-1*n[C]||v<-1*B[C])&&!y.infiniteSlider){for((v>-1*n[C]||v<-1*B[C])&&!y.infiniteSlider?k.splice(0,k.length):(k.splice(.1*k.length,k.length),v=0<k.length?k[k.length-1]:v);v<E[e]-.5||v>E[e]+.5;)v=(v-E[e])*snapFrictionCoefficient+
E[e],k[k.length]=v;k[k.length]=E[e]}G=1;0!=k.length%2&&(G=0);for(v=0;v<h.length;v++)clearTimeout(h[v]);q=(e+q+D)%D;S=0;for(v=G;v<k.length;v+=2)if(v==G||1<Math.abs(k[v]-S)||v>=k.length-2)S=k[v],h[h.length]=m.slowScrollHorizontalIntervalTimer(10*v,b,c,k[v],d,g,f,l,p,w,e,z,u,x,D,O,C,F,q,y);S=(e+K[C]+D)%D;""!=y.onSlideComplete&&1<k.length&&(h[h.length]=m.onSlideCompleteTimer(10*(v+1),y,b,a(b).children(":eq("+S+")"),q,C));X[C]=h;m.hideScrollbar(y,h,v,k,d,g,f,p,w,C)},onSlideComplete:function(b,c,h,d,e){h=
new m.args("complete",b,a(c),h,d,d);a(c).parent().data("args",h);if(""!=b.onSlideComplete)b.onSlideComplete(h)},getSliderOffset:function(b,c){var d;c="x"==c?4:5;if(!f||p||w)d=parseInt(a(b).css("left"),10);else{d=["-webkit-transform","-moz-transform","transform"];for(var e,g=0;g<d.length;g++)if(void 0!=a(b).css(d[g])&&0<a(b).css(d[g]).length){e=a(b).css(d[g]).split(",");break}d=void 0==e[c]?0:parseInt(e[c],10)}return d},setSliderOffset:function(b,c){c=parseInt(c,10);!f||p||w?a(b).css({left:c+"px"}):
a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(y="-webkit-grab",z="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?(u=!0,y="move",z="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?D=p=!0:null!=navigator.userAgent.match("MSIE 8")?D=w=!0:null!=navigator.userAgent.match("MSIE 9")&&(D=!0)},has3DTransform:function(){var b=
!1,c=a("<div />").css({msTransform:"matrix(1,1,1,1,1,1)",webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});""==c.attr("style")?b=!1:u&&21<=parseInt(navigator.userAgent.split("/")[3],10)?b=!1:void 0!=c.attr("style")&&(b=!0);return b},getSlideNumber:function(a,b,c){return(a-K[b]+c)%c},calcActiveOffset:function(a,b,c,d,e,g,f,l){e=!1;a=[];var h;b>c[0]&&(h=0);b<c[c.length-1]&&(h=g-1);for(g=0;g<c.length;g++)c[g]<=b&&c[g]>b-d&&(e||c[g]==b||(a[a.length]=
c[g-1]),a[a.length]=c[g],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(g=e=0;g<a.length;g++)f=Math.abs(b-a[g]),f<d&&(e=a[g],d=f);for(g=0;g<c.length;g++)e==c[g]&&(h=g);return h},changeSlide:function(b,c,d,e,g,f,l,p,w,u,r,z,y,n,C,x,D,q){m.autoSlidePause(n);for(var h=0;h<e.length;h++)clearTimeout(e[h]);var k=Math.ceil(q.autoSlideTransTimer/10)+1,v=m.getSliderOffset(c,"x"),A=z[b],G=A-v;if(q.infiniteSlider)for(b=(b-K[n]+2*x)%x,h=!1,0==b&&2==x&&(b=x,z[b]=z[b-1]-a(d).eq(0).outerWidth(!0),h=!0),A=z[b],G=A-
v,A=[z[b]-a(c).width(),z[b]+a(c).width()],h&&z.splice(z.length-1,1),h=0;h<A.length;h++)Math.abs(A[h]-v)<Math.abs(G)&&(G=A[h]-v);var A=[],P;m.showScrollbar(q,g);for(h=0;h<=k;h++)P=h,P/=k,P--,P=v+G*(Math.pow(P,5)+1),A[A.length]=P;k=(b+K[n]+x)%x;for(h=v=0;h<A.length;h++){if(0==h||1<Math.abs(A[h]-v)||h>=A.length-2)v=A[h],e[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,d,A[h],g,f,l,p,w,u,b,r,z,C,x,y,n,D,k,q);0==h&&""!=q.onSlideStart&&(G=(J[n]+K[n]+x)%x,q.onSlideStart(new m.args("start",q,c,a(c).children(":eq("+
G+")"),G,b)))}v=!1;q.infiniteSlider?k!=aa[n]&&(v=!0):b!=J[n]&&(v=!0);v&&""!=q.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(h+1),q,c,a(c).children(":eq("+k+")"),k,n));X[n]=e;m.hideScrollbar(q,e,h,A,g,f,l,w,u,n);m.autoSlide(c,d,e,g,f,l,p,w,u,r,z,y,n,C,x,D,q)},autoSlide:function(a,b,c,d,e,g,f,l,p,w,r,z,n,u,y,x,D){if(!Q[n].autoSlide)return!1;m.autoSlidePause(n);V[n]=setTimeout(function(){!D.infiniteSlider&&J[n]>r.length-1&&(J[n]-=y);m.changeSlide((J[n]+K[n]+r.length+1)%r.length,a,b,c,d,e,
g,f,l,p,w,r,z,n,u,y,x,D);m.autoSlide(a,b,c,d,e,g,f,l,p,w,r,z,n,u,y,x,D)},D.autoSlideTimer+D.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(V[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,g,f,l,p,w,n,z,u,y,D,x,B,q,E,F){return setTimeout(function(){m.slowScrollHorizontalInterval(b,c,d,e,g,f,l,p,w,n,z,u,y,D,x,B,q,E,F)},a)},onSlideCompleteTimer:function(a,b,c,
d,e,g){return setTimeout(function(){m.onSlideComplete(b,c,d,e,g)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,e,g,f,l,p,w){return setTimeout(function(){m.hideScrollbarInterval(b,c,d,e,g,f,l,p,w)},a)},args:function(b,c,d,e,g,f){this.prevSlideNumber=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideNumber;this.prevSlideObject=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideObject;this.targetSlideNumber=f+1;this.targetSlideObject=a(d).children(":eq("+
...
this.sliderObject=d;this.sliderContainerObject=a(d).parent();this.currentSlideObject=e;this.currentSlideNumber=g+1;this.currentSliderOffset=-1*m.getSliderOffset(d,"x")},preventDrag:function(a){a.preventDefault()},preventClick:function(a){a.stopImmediatePropagation();return!1},enableClick:function(){return!0}};m.setBrowserInfo();var Y={init:function(G,u){f=m.has3DTransform();var h=a.extend(!0,{elasticPullResistance:.6,frictionCoefficient:.92,elasticFrictionCoefficient:.6,snapFrictionCoefficient:.92,
snapToChildren:!1,snapSlideCenter:!1,startAtSlide:1,scrollbar:!1,scrollbarDrag:!1,scrollbarHide:!0,scrollbarLocation:"top",scrollbarContainer:"",scrollbarOpacity:.4,scrollbarHeight:"4px",scrollbarBorder:"0",scrollbarMargin:"5px",scrollbarBackground:"#000",scrollbarBorderRadius:"100px",scrollbarShadow:"0 0 0 #000",scrollbarElasticPullResistance:.9,desktopClickDrag:!1,keyboardControls:!1,tabToAdvance:!1,responsiveSlideContainer:!0,responsiveSlides:!0,navSlideSelector:"",navPrevSelector:"",navNextSelector:"",
autoSlideToggleSelector:"",autoSlide:!1,autoSlideTimer:5E3,autoSlideTransTimer:750,autoSlideHoverPause:!0,infiniteSlider:!1,snapVelocityThreshold:5,slideStartVelocityThreshold:0,horizontalSlideLockThreshold:5,verticalSlideLockThreshold:3,stageCSS:{position:"relative",top:"0",left:"0",overflow:"hidden",zIndex:1},unselectableSelector:"",onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},G);void 0==u&&(u=this);return a(u).each(function(f){function v(){m.autoSlidePause(k);
xa=a(H).find("a");Ca=a(H).find("[onclick]");ra=a(H).find("*");a(E).css("width","");a(E).css("height","");a(H).css("width","");I=a(H).children().not("script").get();ja=[];R=[];h.responsiveSlides&&a(I).css("width","");B[k]=0;t=[];x=a(E).parent().width();F=a(E).outerWidth(!0);h.responsiveSlideContainer&&(F=a(E).outerWidth(!0)>x?x:a(E).width());a(E).css({position:h.stageCSS.position,top:h.stageCSS.top,left:h.stageCSS.left,overflow:h.stageCSS.overflow,zIndex:h.stageCSS.zIndex,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",
msTouchAction:"pan-y",width:F});a(h.unselectableSelector).css({cursor:"default"});for(var b=0;b<I.length;b++){ja[b]=a(I[b]).width();R[b]=a(I[b]).outerWidth(!0);var c=R[b];h.responsiveSlides&&(R[b]>F?(c=F+-1*(R[b]-ja[b]),ja[b]=c,R[b]=F):c=ja[b],a(I[b]).css({width:c}));a(I[b]).css({webkitBackfaceVisibility:"hidden",overflow:"hidden",position:"absolute"});t[b]=-1*B[k];B[k]=B[k]+c+(R[b]-ja[b])}h.snapSlideCenter&&(q=.5*(F-R[0]),h.responsiveSlides&&R[0]>F&&(q=0));ba[k]=2*B[k];for(b=0;b<I.length;b++)m.setSliderOffset(a(I[b]),
-1*t[b]+B[k]+q),t[b]-=B[k];if(!h.infiniteSlider&&!h.snapSlideCenter){for(b=0;b<t.length&&!(t[b]<=-1*(2*B[k]-F));b++)Da=b;t.splice(Da+1,t.length);t[t.length]=-1*(2*B[k]-F)}for(b=0;b<t.length;b++)W[b]=t[b];va&&(Q[k].startAtSlide=Q[k].startAtSlide>t.length?t.length:Q[k].startAtSlide,h.infiniteSlider?(Q[k].startAtSlide=(Q[k].startAtSlide-1+M)%M,J[k]=Q[k].startAtSlide):(Q[k].startAtSlide=0>Q[k].startAtSlide-1?t.length-1:Q[k].startAtSlide,J[k]=Q[k].startAtSlide-1),aa[k]=J[k]);n[k]=B[k]+q;a(H).css({position:"relative",
cursor:y,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:B[k]+"px"});da=B[k];B[k]=2*B[k]-F+2*q;(ea=da+q<F||0==F?!0:!1)&&a(H).css({cursor:"default"});Y=a(E).parent().outerHeight(!0);ma=a(E).height();h.responsiveSlideContainer&&(ma=ma>Y?Y:ma);a(E).css({height:ma});m.setSliderOffset(H,t[J[k]]);if(h.infiniteSlider&&!ea){b=m.getSliderOffset(a(H),"x");for(c=(K[k]+M)%M*-1;0>c;){var d=0,e=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,
"x"),d=a)});var g=n[k]+da;m.setSliderOffset(a(I)[d],g);n[k]=-1*t[1]+q;B[k]=n[k]+da-F;t.splice(0,1);t.splice(t.length,0,-1*g+q);c++}for(;0<-1*t[0]-da+q&&h.snapSlideCenter&&va;){var f=0,v=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>v&&(v=m.getSliderOffset(this,"x"),f=a)});g=n[k]-R[f];m.setSliderOffset(a(I)[f],g);t.splice(0,0,-1*g+q);t.splice(t.length-1,1);n[k]=-1*t[0]+q;B[k]=n[k]+da-F;K[k]--;J[k]++}for(;b<=-1*B[k];)d=0,e=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,
"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)}),g=n[k]+da,m.setSliderOffset(a(I)[d],g),n[k]=-1*t[1]+q,B[k]=n[k]+da-F,t.splice(0,1),t.splice(t.length,0,-1*g+q),K[k]++,J[k]--}m.setSliderOffset(H,t[J[k]]);h.desktopClickDrag||a(H).css({cursor:"default"});h.scrollbar&&(a("."+N).css({margin:h.scrollbarMargin,overflow:"hidden",display:"none"}),a("."+N+" ."+r).css({border:h.scrollbarBorder}),T=parseInt(a("."+N).css("marginLeft"))+parseInt(a("."+N).css("marginRight")),U=parseInt(a("."+N+" ."+r).css("borderLeftWidth"),
10)+parseInt(a("."+N+" ."+r).css("borderRightWidth"),10),O=""!=h.scrollbarContainer?a(h.scrollbarContainer).width():F,C=F/da*(O-T),h.scrollbarHide||(wa=h.scrollbarOpacity),a("."+N).css({position:"absolute",left:0,width:O-T+"px",margin:h.scrollbarMargin}),"top"==h.scrollbarLocation?a("."+N).css("top","0"):a("."+N).css("bottom","0"),a("."+N+" ."+r).css({borderRadius:h.scrollbarBorderRadius,background:h.scrollbarBackground,height:h.scrollbarHeight,width:C-U+"px",minWidth:h.scrollbarHeight,border:h.scrollbarBorder,
webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:wa,filter:"alpha(opacity:"+100*wa+")",boxShadow:h.scrollbarShadow}),m.setSliderOffset(a("."+N+" ."+r),Math.floor((-1*t[J[k]]-n[k]+q)/(B[k]-n[k]+q)*(O-T-C))),a("."+N).css({display:"block"}),L=a("."+N+" ."+r),V=a("."+N));h.scrollbarDrag&&!ea&&a("."+N+" ."+r).css({cursor:y});h.infiniteSlider&&(Z=(B[k]+F)/3);""!=h.navSlideSelector&&a(h.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"});a(this).unbind(ca).bind(ca,
function(c){"touchstart"==c.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=c.type+".iosSliderEvent";m.changeSlide(b,H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h)})});""!=h.navPrevSelector&&(a(h.navPrevSelector).css({cursor:"pointer"}),a(h.navPrevSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(J[k]+K[k]+M)%M;(0<b||h.infiniteSlider)&&m.changeSlide(b-
1,H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h)}));""!=h.navNextSelector&&(a(h.navNextSelector).css({cursor:"pointer"}),a(h.navNextSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";b=(J[k]+K[k]+M)%M;(b<t.length-1||h.infiniteSlider)&&m.changeSlide(b+1,H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h)}));h.autoSlide&&!ea&&""!=h.autoSlideToggleSelector&&(a(h.autoSlideToggleSelector).css({cursor:"pointer"}),
a(h.autoSlideToggleSelector).unbind(ca).bind(ca,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ca=b.type+".iosSliderEvent";na?(m.autoSlide(H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h),na=!1,a(h.autoSlideToggleSelector).removeClass("on")):(m.autoSlidePause(k),na=!0,a(h.autoSlideToggleSelector).addClass("on"))}));m.autoSlide(H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h);a(E).bind("mouseleave.iosSliderEvent",function(){if(na)return!0;m.autoSlide(H,I,G,
r,C,F,O,T,U,W,t,R,k,Z,M,q,h)});a(E).bind("touchend.iosSliderEvent",function(){if(na)return!0;m.autoSlide(H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h)});h.autoSlideHoverPause&&a(E).bind("mouseenter.iosSliderEvent",function(){m.autoSlidePause(k)});a(E).data("iosslider",{obj:Ea,settings:h,scrollerNode:H,slideNodes:I,numberOfSlides:M,centeredSlideOffset:q,sliderNumber:k,originalOffsets:W,childrenOffsets:t,sliderMax:B[k],scrollbarClass:r,scrollbarWidth:C,scrollbarStageWidth:O,stageWidth:F,scrollMargin:T,scrollBorder:U,
infiniteSliderOffset:K[k],infiniteSliderWidth:Z,slideNodeOuterWidths:R,shortContent:ea});va=!1;return!0}b++;var k=b,G=[];Q[k]=a.extend({},h);n[k]=0;B[k]=0;var u=[0,0],S=[0,0],N="scrollbarBlock"+b,r="scrollbar"+b,L,V,O,C,x,Y,q=0,E=a(this),F,ma,T,U,Ba,va=!0;f=-1;var t,W=[],wa=0,ha=0,Fa=0,H=a(this).children(":first-child"),I,ja,R,M=a(H).children().not("script").length,fa=!1,Da=0,ya=!1,sa=void 0,Z;K[k]=0;var ea=!1,na=!1;la[k]=!1;var ia,ta=!1,oa=!1,ca="touchstart.iosSliderEvent click.iosSliderEvent",da,
xa,Ca,ra;ga[k]=!1;X[k]=[];h.scrollbarDrag&&(h.scrollbar=!0,h.scrollbarHide=!1);var Ea=a(this);if(void 0!=Ea.data("iosslider"))return!0;var pa=[],qa=Math.floor(12317*Math.random());a(H).parent().append("<i class = 'i"+qa+"'></i>").append("<i class = 'i"+qa+"'></i>");a(".i"+qa).css({position:"absolute",right:"10px",bottom:"10px",zIndex:1E3,fontStyle:"normal",background:"#fff",opacity:.2}).eq(1).css({bottom:"auto",right:"auto",top:"10px",left:"10px"});for(f=0;f<pa.length;f++)a(".i"+qa).html(a(".i"+qa).html()+
pa[f]);14.2<=parseInt(a().jquery.split(".").join(""),10)?a(this).delegate("img","dragstart.iosSliderEvent",function(a){a.preventDefault()}):a(this).find("img").bind("dragstart.iosSliderEvent",function(a){a.preventDefault()});h.infiniteSlider&&(h.scrollbar=!1);h.infiniteSlider&&1==M&&(h.infiniteSlider=!1);h.scrollbar&&(""!=h.scrollbarContainer?a(h.scrollbarContainer).append("<div class = '"+N+"'><div class = '"+r+"'></div></div>"):a(H).parent().append("<div class = '"+N+"'><div class = '"+r+"'></div></div>"));
if(!v())return!0;a(this).find("a").bind("mousedown",m.preventDrag);a(this).find("[onclick]").bind("click",m.preventDrag).each(function(){a(this).data("onclick",this.onclick)});f=m.calcActiveOffset(h,m.getSliderOffset(a(H),"x"),t,F,K[k],M,void 0,k);f=(f+K[k]+M)%M;f=new m.args("load",h,H,a(H).children(":eq("+f+")"),f,f);a(E).data("args",f);if(""!=h.onSliderLoaded)h.onSliderLoaded(f);if(Q[k].responsiveSlides||Q[k].responsiveSlideContainer)f=l?"orientationchange":"resize",a(window).bind(f+".iosSliderEvent-"+
k,function(){if(!v())return!0;var b=a(E).data("args");if(""!=h.onSliderResize)h.onSliderResize(b)});!h.keyboardControls&&!h.tabToAdvance||ea||a(document).bind("keydown.iosSliderEvent",function(a){p||w||(a=a.originalEvent);if(ga[k])return!0;if(37==a.keyCode&&h.keyboardControls)a.preventDefault(),a=(J[k]+K[k]+M)%M,(0<a||h.infiniteSlider)&&m.changeSlide(a-1,H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h);else if(39==a.keyCode&&h.keyboardControls||9==a.keyCode&&h.tabToAdvance)a.preventDefault(),a=(J[k]+K[k]+M)%M,
(a<t.length-1||h.infiniteSlider)&&m.changeSlide(a+1,H,I,G,r,C,F,O,T,U,W,t,R,k,Z,M,q,h)});if(g||h.desktopClickDrag){var ka=!1,za=!1;f=a(H);var ua=a(H),Aa=!1;h.scrollbarDrag&&(f=f.add(L),ua=ua.add(V));a(f).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent",function(b){if(ka)return!0;ka=!0;za=!1;"touchstart"==b.type?a(ua).unbind("mousedown.iosSliderEvent"):a(ua).unbind("touchstart.iosSliderEvent");if(ga[k]||ea||(Aa=m.isUnselectable(b.target,h)))return fa=ka=!1,!0;ia=a(this)[0]===a(L)[0]?L:H;p||
w||(b=b.originalEvent);m.autoSlidePause(k);ra.unbind(".disableClick");if("touchstart"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(w)try{document.selection.empty()}catch(Ga){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;ya=!0;sa=H;a(this).css({cursor:z})}u=[0,0];S=[0,0];c=0;
fa=!1;for(b=0;b<G.length;b++)clearTimeout(G[b]);b=m.getSliderOffset(H,"x");b>-1*n[k]+q+da?(b=-1*n[k]+q+da,m.setSliderOffset(a("."+r),b),a("."+r).css({width:C-U+"px"})):b<-1*B[k]&&(m.setSliderOffset(a("."+r),O-T-C),a("."+r).css({width:C-U+"px"}));b=a(this)[0]===a(L)[0]?n[k]:0;ha=-1*(m.getSliderOffset(this,"x")-eventX-b);m.getSliderOffset(this,"y");u[1]=eventX;S[1]=eventY;oa=!1});a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",function(b){p||w||(b=b.originalEvent);if(ga[k]||ea||
...
u[1];u[1]=eventX;c=(u[1]-u[0])/2;S[0]=S[1];S[1]=eventY;d=(S[1]-S[0])/2;if(!fa){var f=(J[k]+K[k]+M)%M,f=new m.args("start",h,H,a(H).children(":eq("+f+")"),f,void 0);a(E).data("args",f);if(""!=h.onSlideStart)h.onSlideStart(f)}(d>h.verticalSlideLockThreshold||d<-1*h.verticalSlideLockThreshold)&&"touchmove"==b.type&&!fa&&(ta=!0);(c>h.horizontalSlideLockThreshold||c<-1*h.horizontalSlideLockThreshold)&&"touchmove"==b.type&&b.preventDefault();if(c>h.slideStartVelocityThreshold||c<-1*h.slideStartVelocityThreshold)fa=
!0;if(fa&&!ta){var f=m.getSliderOffset(H,"x"),v=a(ia)[0]===a(L)[0]?n[k]:q,l=a(ia)[0]===a(L)[0]?(n[k]-B[k]-q)/(O-T-C):1,A=a(ia)[0]===a(L)[0]?h.scrollbarElasticPullResistance:h.elasticPullResistance,G=h.snapSlideCenter&&a(ia)[0]===a(L)[0]?0:q,z=h.snapSlideCenter&&a(ia)[0]===a(L)[0]?q:0;"touchmove"==b.type&&(Fa!=b.touches.length&&(ha=-1*f+eventX),Fa=b.touches.length);if(h.infiniteSlider){if(f<=-1*B[k]){var y=a(H).width();if(f<=-1*ba[k]){var P=-1*W[0];a(I).each(function(b){m.setSliderOffset(a(I)[b],P+
q);b<t.length&&(t[b]=-1*P);P+=R[b]});ha-=-1*t[0];n[k]=-1*t[0]+q;B[k]=n[k]+y-F;K[k]=0}else{var x=0,N=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<N&&(N=m.getSliderOffset(this,"x"),x=a)});A=n[k]+y;m.setSliderOffset(a(I)[x],A);n[k]=-1*t[1]+q;B[k]=n[k]+y-F;t.splice(0,1);t.splice(t.length,0,-1*A+q);K[k]++}}if(f>=-1*n[k]||0<=f)if(y=a(H).width(),0<=f)for(P=-1*W[0],a(I).each(function(b){m.setSliderOffset(a(I)[b],P+q);b<t.length&&(t[b]=-1*P);P+=R[b]}),ha+=-1*t[0],n[k]=-1*
t[0]+q,B[k]=n[k]+y-F,K[k]=M;0<-1*t[0]-y+q;){var V=0,Q=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),V=a)});A=n[k]-R[V];m.setSliderOffset(a(I)[V],A);t.splice(0,0,-1*A+q);t.splice(t.length-1,1);n[k]=-1*t[0]+q;B[k]=n[k]+y-F;K[k]--;J[k]++}else V=0,Q=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),V=a)}),A=n[k]-R[V],m.setSliderOffset(a(I)[V],A),t.splice(0,0,-1*A+q),t.splice(t.length-
1,1),n[k]=-1*t[0]+q,B[k]=n[k]+y-F,K[k]--}else y=a(H).width(),f>-1*n[k]+q&&(g=(n[k]+-1*(ha-v-eventX+G)*l-v)*A*-1/l),f<-1*B[k]&&(g=(B[k]+z+-1*(ha-v-eventX)*l-v)*A*-1/l);m.setSliderOffset(H,-1*(ha-v-eventX-g)*l-v+z);h.scrollbar&&(m.showScrollbar(h,r),e=Math.floor((ha-eventX-g-n[k]+G)/(B[k]-n[k]+q)*(O-T-C)*l),f=C,0>=e?(f=C-U- -1*e,m.setSliderOffset(a("."+r),0),a("."+r).css({width:f+"px"})):e>=O-T-U-C?(f=O-T-U-e,m.setSliderOffset(a("."+r),e),a("."+r).css({width:f+"px"})):m.setSliderOffset(a("."+r),e));
"touchmove"==b.type&&(Ba=b.touches[0].pageX);b=!1;g=m.calcActiveOffset(h,-1*(ha-eventX-g),t,F,K[k],M,void 0,k);f=(g+K[k]+M)%M;h.infiniteSlider?f!=aa[k]&&(b=!0):g!=J[k]&&(b=!0);if(b&&(J[k]=g,aa[k]=f,oa=!0,f=new m.args("change",h,H,a(H).children(":eq("+f+")"),f,f),a(E).data("args",f),""!=h.onSlideChange))h.onSlideChange(f)}});pa=a(window);if(w||p)pa=a(document);a(f).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",function(a){a=a.originalEvent;if(za)return!1;za=!0;if(ga[k]||ea||Aa)return!0;
if(0!=a.touches.length)for(var b=0;b<a.touches.length;b++)a.touches[b].pageX==Ba&&m.slowScrollHorizontal(H,I,G,r,c,d,C,F,O,T,U,W,t,R,k,Z,M,ia,oa,q,h);else m.slowScrollHorizontal(H,I,G,r,c,d,C,F,O,T,U,W,t,R,k,Z,M,ia,oa,q,h);ka=ta=!1;return!0});a(pa).bind("mouseup.iosSliderEvent-"+k,function(b){fa?xa.unbind("click.disableClick").bind("click.disableClick",m.preventClick):xa.unbind("click.disableClick").bind("click.disableClick",m.enableClick);Ca.each(function(){this.onclick=function(b){if(fa)return!1;
...
b.click[0].namespace){if(!fa)return!1;a(this).one("click.disableClick",m.preventClick);var b=a(this).data("events").click,c=b.pop();b.splice(0,0,c)}});if(!la[k]){if(ea)return!0;h.desktopClickDrag&&a(H).css({cursor:y});h.scrollbarDrag&&a(L).css({cursor:y});ya=!1;if(void 0==sa)return!0;m.slowScrollHorizontal(sa,I,G,r,c,d,C,F,O,T,U,W,t,R,k,Z,M,ia,oa,q,h);sa=void 0}ka=ta=!1})}})},destroy:function(b,c){void 0==c&&(c=this);return a(c).each(function(){var c=a(this),d=c.data("iosslider");if(void 0==d)return!1;
...
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);h=b.wH=D.height();f={};b.fixedContentPos&&b._hasScrollBar(h)&&(g=b._getScrollbarSize())&&(f.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):f.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),z("BuildControls"),a("html").css(f),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
setTimeout(function(){b.content?(b._addClassToMFP("mfp-ready"),b._setFocus()):b.bgOverlay.addClass("mfp-ready");e.on("focusin.mfp",b._onFocusIn)},16),b.isOpen=!0,b.updateSize(h),z("Open"),c},close:function(){b.isOpen&&(z("BeforeClose"),b.isOpen=!1,b.st.removalDelay&&!b.isLowIE&&b.supportsTransition?(b._addClassToMFP("mfp-removing"),setTimeout(function(){b._close()},b.st.removalDelay)):b._close())},_close:function(){z("Close");var c="mfp-removing mfp-ready ";if(b.bgOverlay.detach(),b.wrap.detach(),
...
b.content.find(".mfp-close").length||b.content.append(V()):b.content=a:b.content="";z("BeforeAppend");b.container.addClass("mfp-"+c+"-holder");b.contentContainer.append(b.content)},parseEl:function(c){var d,e=b.items[c];if(e.tagName?e={el:a(e)}:(d=e.type,e={data:e,src:e.src}),e.el){for(var h=b.types,f=0;h.length>f;f++)if(e.el.hasClass("mfp-"+h[f])){d=h[f];break}e.src=e.el.attr("data-mfp-src");e.src||(e.src=e.el.attr("href"))}return e.type=d||b.st.type||"inline",e.index=c,e.parsed=!0,b.items[c]=e,
...
document.body.removeChild(a)}return b.scrollbarSize}};a.magnificPopup={instance:null,proto:p.prototype,modules:[],open:function(b,c){return Q(),b=b?a.extend(!0,{},b):{},b.isObj=!0,b.index=c||0,this.instance.open(b)},close:function(){return a.magnificPopup.instance&&a.magnificPopup.instance.close()},registerModule:function(b,c){c.options&&(a.magnificPopup.defaults[b]=c.options);a.extend(this.proto,c.proto);this.modules.push(b)},defaults:{disableOn:0,key:null,midClick:!1,mainClass:"",preloader:!0,focus:"",
...
u("Close.inline",function(){K()})},getInline:function(c,d){if(K(),c.src){var e=b.st.inline,f=a(c.src);if(f.length){var g=f[0].parentNode;g&&g.tagName&&(J||(X=e.hiddenClass,J=y(X),X="mfp-"+X),aa=f.after(J).detach().removeClass(X));b.updateStatus("ready")}else b.updateStatus("error",e.tNotFound),f=a("<div>");return c.inlineElement=f,f}return b.updateStatus("ready"),b._parseMarkup(d,{},c),d}}});var n,B=function(){n&&d.removeClass(n);b.req&&b.req.abort()};a.magnificPopup.registerModule("ajax",{options:{settings:null,
cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){b.types.push("ajax");n=b.st.ajax.cursor;u("Close.ajax",B);u("BeforeChange.ajax",B)},getAjax:function(c){n&&d.addClass(n);b.updateStatus("loading");var e=a.extend({url:c.src,success:function(e,f,g){e={data:e,xhr:g};z("ParseAjax",e);b.appendContent(a(e.data),"ajax");c.finished=!0;n&&d.removeClass(n);b._setFocus();setTimeout(function(){b.wrap.addClass("mfp-ready")},16);b.updateStatus("ready");
...
cursor:"mfp-zoom-out-cur",titleSrc:"title",verticalFit:!0,tError:'<a href="%url%">The image</a> could not be loaded.'},proto:{initImage:function(){var a=b.st.image;b.types.push("image");u("Open.image",function(){"image"===b.currItem.type&&a.cursor&&d.addClass(a.cursor)});u("Close.image",function(){a.cursor&&d.removeClass(a.cursor);D.off("resize.mfp")});u("Resize.image",b.resizeImage);b.isLowIE&&u("AfterChange",b.resizeImage)},resizeImage:function(){var a=b.currItem;if(a&&a.img&&b.st.image.verticalFit){var c=
...
setTimeout(function(){e.remove();a=e=null;z("ZoomAnimationEnded")},16)},f)},16)}});u("BeforeClose.zoom",function(){if(b._allowZoom()){if(clearTimeout(d),b.st.removalDelay=f,!a){if(a=b._getItemToZoom(),!a)return;e=g(a)}e.css(b._getOffset(!0));b.wrap.append(e);b.content.css("visibility","hidden");setTimeout(function(){e.css(b._getOffset())},16)}});u("Close.zoom",function(){b._allowZoom()&&(l(),e&&e.remove(),a=null)})}},_allowZoom:function(){return"image"===b.currItem.type},_getItemToZoom:function(){return b.currItem.hasSize?
...
gmaps:{index:"//maps.google.",src:"%id%&output=embed"}}},proto:{initIframe:function(){b.types.push("iframe");u("BeforeChange",function(a,b,c){b!==c&&("iframe"===b?Y():"iframe"===c&&Y(!0))});u("Close.iframe",function(){Y()})},getIframe:function(c,d){var e=c.src,f=b.st.iframe;a.each(f.patterns,function(){return-1<e.indexOf(this.index)?(this.id&&(e="string"==typeof this.id?e.substr(e.lastIndexOf(this.id)+this.id.length,e.length):this.id.call(this,e)),e=this.src.replace("%id%",e),!1):void 0});var g={};
return f.srcAction&&(g[f.srcAction]=e),b._parseMarkup(d,g,c),b.updateStatus("ready"),d}}});var G=function(a){var c=b.items.length;return a>c-1?a-c:0>a?c+a:a},S=function(a,b,c){return a.replace(/%curr%/gi,b+1).replace(/%total%/gi,c)};a.magnificPopup.registerModule("gallery",{options:{enabled:!1,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload:[0,2],navigateByImgClick:!0,arrows:!0,tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(l+=" mfp-gallery",u("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});e.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),u("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=S(c.text,b.currItem.index,b.items.length))}),
u("MarkupParse.mfp-gallery",function(a,d,e,f){a=b.items.length;e.counter=1<a?S(c.tCounter,f.index,a):""}),u("BuildControls.mfp-gallery",function(){if(1<b.items.length&&c.arrows&&!b.arrowLeft){var e=c.arrowMarkup,f=b.arrowLeft=a(e.replace(/%title%/gi,c.tPrev).replace(/%dir%/gi,"left")).addClass("mfp-prevent-close"),e=b.arrowRight=a(e.replace(/%title%/gi,c.tNext).replace(/%dir%/gi,"right")).addClass("mfp-prevent-close"),g=d?"mfpFastClick":"click";f[g](function(){b.prev()});e[g](function(){b.next()});
...
!0;b.index=G(b.index+1);b.updateItemHTML()},prev:function(){b.direction=!1;b.index=G(b.index-1);b.updateItemHTML()},goTo:function(a){b.direction=a>=b.index;b.index=a;b.updateItemHTML()},preloadNearbyImages:function(){var a;a=b.st.gallery.preload;var c=Math.min(a[0],b.items.length),d=Math.min(a[1],b.items.length);for(a=1;(b.direction?d:c)>=a;a++)b._preloadItem(b.index+a);for(a=1;(b.direction?c:d)>=a;a++)b._preloadItem(b.index-a)},_preloadItem:function(c){if(c=G(c),!b.items[c].preloaded){var d=b.items[c];
...
c():c;1<c&&(u("ImageHasSize.retina",function(a,b){b.img.css({"max-width":b.img[0].naturalWidth/c,width:"100%"})}),u("ElementParse.retina",function(b,d){d.src=a.replaceSrc(d,c)}))}}}});(function(){var b="ontouchstart"in window,c=function(){D.off("touchmove"+d+" touchend"+d)},d=".mfpFastClick";a.fn.mfpFastClick=function(e){return a(this).each(function(){var f,g=a(this);if(b){var h,l,k,p,m,w;g.on("touchstart"+d,function(a){p=!1;w=1;m=a.originalEvent?a.originalEvent.touches[0]:a.touches[0];l=m.clientX;
k=m.clientY;D.on("touchmove"+d,function(a){m=a.originalEvent?a.originalEvent.touches:a.touches;w=m.length;m=m[0];(10<Math.abs(m.clientX-l)||10<Math.abs(m.clientY-k))&&(p=!0,c())}).on("touchend"+d,function(a){c();p||1<w||(f=!0,a.preventDefault(),clearTimeout(h),h=setTimeout(function(){f=!1},1E3),e())})})}g.on("click"+d,function(){f||e()})})};a.fn.destroyMfpFastClick=function(){a(this).off("touchstart"+d+" click"+d);b&&D.off("touchmove"+d+" touchend"+d)}})();Q()})(window.jQuery||window.Zepto);
...
this.id;if(""==this.value){if("password"==this.type){if(!b.data("placeholder-textinput")){try{a=b.clone().attr({type:"text"})}catch(Q){a=c("<input>").attr(c.extend(d(this),{type:"text"}))}a.removeAttr("name").data({"placeholder-password":b,"placeholder-id":f}).bind("focus.placeholder",e);b.data({"placeholder-textinput":a,"placeholder-id":f}).before(a)}b=b.removeAttr("id").hide().prev().attr("id",f).show()}b.addClass("placeholder");b[0].value=b.attr("placeholder")}else b.removeClass("placeholder")}
function l(){try{return b.activeElement}catch(y){}}var f="placeholder"in b.createElement("input"),p="placeholder"in b.createElement("textarea"),w=c.fn,D=c.valHooks,u=c.propHooks;f&&p?(w=w.placeholder=function(){return this},w.input=w.textarea=!0):(w=w.placeholder=function(){this.filter((f?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":e,"blur.placeholder":g}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},w.input=f,w.textarea=p,w={get:function(a){var b=
c(a),d=b.data("placeholder-password");return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),f=d.data("placeholder-password");if(f)return f[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=l()&&g.call(a)):d.hasClass("placeholder")?e.call(a,!0,b)||(a.value=b):a.value=b;return d}},f||(D.input=w,u.value=w),p||(D.textarea=w,u.value=w),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=
...
a.parent().children("ul").hide()):(c=b.siblings(),c.removeClass(tdMenu._openMenuClass),c.find("ul").hide(),c.find("li").removeClass(tdMenu._openMenuClass)),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b),d.addClass(tdMenu._openMenuBodyClass))});else{var c={},d,e=!0;b.on("mouseleave",function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}});b.find(".menu-item").hover(function(){var b=jQuery(this),l="",f,p,w,D;b.hasClass("menu-item-has-children")||
b.hasClass("td-mega-menu")?b.parent().hasClass("sf-menu")?jQuery.isEmptyObject(c)?(b.addClass(tdMenu._openMenuClass),b.children("ul").show(),c=b):b[0]!==c[0]&&(w=p=f=0,D=null,!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();b.addClass(tdMenu._openMenuClass);b.children("ul").show();c=b},400)),b.on("mousemove",function(g){5<=f?(f=0,D=tdMenu._getMouseAngleDirection(p,w,g.pageX,g.pageY),p=g.pageX,w=g.pageY):(f++,0===p&&0===w&&(p=g.pageX,
...
jQuery.isEmptyObject(c)||(w=p=f=0,D=null,!0===e&&(e=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}},400)),b.on("mousemove",function(g){5<=f?(f=0,D=tdMenu._getMouseAngleDirection(p,w,g.pageX,g.pageY),p=g.pageX,w=g.pageY):(f++,0===p&&0===w&&(p=g.pageX,w=g.pageY));null!==D&&(85<D||-85>D)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.off("mousemove"),clearTimeout(d),e=!0,c={})})):(c=b.parent(),l=b.siblings(),
...
a)?f.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(g,f.sidebar_top)&&(f.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===f.sidebar_state&&"up"===d||"case_4_fixed_up"===f.sidebar_state&&"down"===d)f.sidebar_state="case_5_absolute";var p=0,w=tdViewport.getCurrentIntervalItem();null!==w&&(p=w.sidebarWidth);switch(f.sidebar_state){case "case_1_fixed_down":if(!0===f.case_1_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=
!0;f.case_2_run_once=!1;f.case_3_run_once=!1;f.case_4_run_once=!1;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:p,position:"fixed",top:"auto",bottom:"0","z-index":"1"});break;case "case_2_top_of_content":if(!0===f.case_2_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+f.sidebar_state);f.case_1_run_once=!1;f.case_2_run_once=!0;f.case_3_run_once=!1;f.case_4_run_once=!1;f.case_5_run_once=!1;f.case_6_run_once=!1;f.sidebar_jquery_obj.css({width:"auto",position:"static",
...
else{var b=null,c=null;a.horizontal_jquery_obj.find("."+a.horizontal_element_css_class).each(function(d,g){b=jQuery(g);b.css("-webkit-transition","opacity 0.2s");b.css("-moz-transition","opacity 0.2s");b.css("-o-transition","opacity 0.2s");b.css("transition","opacity 0.2s");b.css("opacity","1");c={jquery_object:b,calculated_width:b.outerWidth(!0)};a._horizontal_elements.push(c)});a._vertical_jquery_obj_outer_width=a.vertical_jquery_obj.outerWidth(!0);a.vertical_jquery_obj.css("display","none");var d=
